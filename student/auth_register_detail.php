...
<form   method="post" action="auth_register_moji.php">
 <div id="error">
...
<input class="form-control" placeholder="Enter your email or username" name="first_name" id="first_name" required type="text">

<input class="form-control" placeholder="Enter your email or username" name="pass" value="<?php echo $password;?>" id="pass" required type="hidden">
...
<input class="form-control" placeholder="Enter your last name" name="last_name" required id="last_name" type="text">

<input class="form-control" placeholder="Enter your last name" name="user" value="<?php echo $username;?>" required id="user" type="hidden">
...
<select class="form-control" name="school" id="school" tabindex="1" required>
<option value="" selected="selected"> Select The School You Are Using</option>
<option value="art">School Of Art</option>
...
<input class="form-control" placeholder="Enter your class" name="class_from" required id="class_from" type="text">
<div class="pre-icon os-icon os-icon-fingerprint"></div>
<label id="password-error" style="display: none;"></label>
</div>
