...
<!DOCTYPE html><html>
<head>
<title>Exercise Diploma - <?php echo $COMPANY_NAME;?></title>
...
<script type="text/javascript" src="<?php echo $mi6;?>js/jquery-2.1.4.min.js"></script>
        ...
        <script type="text/javascript" src="<?php echo $mi6;?>js/bootstrap.min.js"></script>
         <script  src="<?php echo $mi6;?>js/login.js"></script>
...
&nbsp;
<h4 class="auth-header"><img src = "img/Kultataso.png" width="100" height="50">Exercise Diploma</h4>
...
<input class="form-control" placeholder="Enter your email or username" name="username" id="username" type="text">
<div class="pre-icon os-icon os-icon-user-male-circle"></div>
</div>

<div class="form-group">
<label for="">Password</label><input class="form-control" placeholder="Enter your password" name="pwd" id="pwd" type="password">
<div class="pre-icon os-icon os-icon-fingerprint"></div>
</div>

<div class="buttons-w form-group">
  <center><button class="mr-4 mb-4 btn-lg btn-outline-secondary btn-rounded" name="btn-save" id="btn-submit"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;Login </button>
  
</center>
</div>

<div class="buttons-w form-group">
 <center><button class="btn btn-white" name="btn-save" id="btn-submit"><i class="fa fa-cogs"></i>&nbsp;&nbsp;Did You Forget Your Password </button><hr><br>
<center><h6>Or Use An Account </h6></center>
...
<center><button class="mr-4 mb-4 btn-lg btn-outline-secondary btn-rounded" name="btn-save" id="btn-submit"><i class="fa fa-google-plus"></i>&nbsp;&nbsp;
  Log in With Google</button></center>
</a>
</div>
...
<center><button class="mr-4 mb-4 btn-lg btn-outline-secondary btn-rounded" name="btn-save" id="btn-submit"><i class="fa fa-windows"></i>&nbsp;&nbsp;
  Log in With Outlook</button></center>
</a>
</div>
...
<div class="buttons-w form-group">
<a href="../index.php">
<center><button class="btn btn-white" name="btn-save" id="btn-submit"><i class="fa fa-empire"></i>&nbsp;&nbsp;Dont Have ID<br>Register </button></center>
</a>
<hr>
</div>
