...
<html lang="en">
<head>
<title>Student Login Confirmation - <?php echo $COMPANY_NAME;?></title>
...
<h4 class="auth-header ">Registration</h4>
...
<h5>Hi <?php  echo $get_first_name;?> </h5>



  <h6><?php echo $get_statusMsg;?></h6>      
  <p>You Have Selected <?php echo $get_character;?> As Your Character And <?php echo $get_pref_level;?> As Your Performance Level</p>       
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            <a href="#">
                <img class="btn btn-outline-secondary" src="<?php echo $get_character_img;?>" width="100" height="100">
            </a>
        </div>&nbsp;&nbsp;&nbsp;
    ...
    <div class="col-md-6">
        <div class="form-group">
            <a href="#">
                <img class="btn btn-outline-secondary " src="<?php echo $get_pref_level_img;?>" disabled width="100" height="100">
            </a>
        </div>&nbsp;&nbsp;&nbsp;
...
<h6> Welcome To Complete The Physical Education Diploma For</h6><br>

<center><h6><?php echo $SERVERDATE1;?> - <?php echo $nextdate;?></h6></center>
...
<div class="buttons-w form-group">
    <center><a href="task.php"><button class="mr-4 mb-4 btn-lg btn-outline-secondary btn-rounded" name="btn-save" id="btn-submit" type="button"><i class="fa fa-windows"></i>&nbsp;
  Go To The Programme &nbsp;</button></a>
</center>
