	...
	<div class="element-box-tp">
		...
		<div class="users-list-w">
			...
			<div class="user-w with-status status-green">
				...
				<div class="user-name">
					<h6 class="user-title">Nature Exercise3</h6>
					<div class="user-role">
						<h6>Progress Report : 10/10</h6>
				...
				<div class="user-name">
					...
					<div class="user-role">
						...
						<div class="progress">
							...
							<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="20" class="progress-bar bg-success" role="progressbar" style="width: 50%"></div>
						</div>
				...
				<div class="user-name">
					...
					<div class="user-role">
						...
						<div class="progress">
							...
							<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="40" class="progress-bar bg-success" role="progressbar" style="width: 50%"></div>
						</div>
