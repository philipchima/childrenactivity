<?php 
    ...
    class Student{
        ...
        // Table
        private $db_table = "student_dbase";
...
/*
			...
			*/
			...
			$insert = $this->conn->prepare("INSERT INTO student_dbase(last_name,first_name,username,password,school,class_from,character_load,pref_level,status,date_created,student_code) VALUES(:last_name, :first_name, :username, :password, :school, :class_from, :character_load,:pref_level, :status, :date_created, :student_code)");
			$insert->execute($data);
			echo $data;
...
/*            $this->last_name=htmlspecialchars(strip_tags($last_name));
            ...
            $this->class_from=htmlspecialchars(strip_tags($this->last_name));
          ...
          */  
            ...
            $stmt->bindParam(":class_from", $class_from);
            $stmt->bindParam(":character_load", $character_load);
            $stmt->bindParam(":pref_level", $pref_level);
